...
// The event's operational home — what used to be `/dashboard` (M4,
// CHALLENGE #6), now rendered at the event root for organizers (W7,
// decision 5). Everything here is a live Convex subscription: a speaker
// confirming in the portal, an upload landing, or a bio being filled in
// another tab moves these numbers without a refresh.
//
...
// That tick is exactly why this content is a ROUTE component and not the
// shell: nothing the shell subscribes to may re-run per minute.
//
// W8 replaces the panels below with the four-question control center. W7 moved
// them; it did not redesign them.
