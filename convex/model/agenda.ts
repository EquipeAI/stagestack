...
export function counts(participant: Doc<"sessionParticipants">): boolean {
...
// Moved verbatim to `./agendaPlanner`. It reads this module (the schedule
// flatteners above) and is read by the public wrappers directly, which keeps
