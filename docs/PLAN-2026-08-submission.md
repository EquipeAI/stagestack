# PLAN (ARCHIVED 2026-08-10)

Historical record of the original build (Phase 0 → M8, Aug 8–9 2026), archived
when the post-eval fix cycle started. The live plan is [/PLAN.md](../PLAN.md).
